...
double depthCamXOffset = 0;                             // the X offset of the depth camera w.r.t the center of the vehicle
double depthCamYOffset = 0;                             // the Y offset of the depth camera w.r.t the center of the vehicle
double depthCamZOffset = 0;                             // the Z offset of the depth camera w.r.t the center of the vehicle
bool trackingCamBackward = false;                       // whether the camera is installed backward
double trackingCamXOffset = 0;                          // the X offset of the tracking camera w.r.t the center of the vehicle
double trackingCamYOffset = 0;                          // the Y offset of the tracking camera w.r.t the center of the vehicle
double trackingCamZOffset = 0;                          // the Z offset of the tracking camera w.r.t the center of the vehicle
...
double lowerBoundZ = -1.2;                              // the z lower bound of path w.r.t track point
double upperBoundZ = 1.2;                               // the z upper bound of path w.r.t track point
      ...
      *laserCloudStack[laserCloudCount] = *laserCloudDwz;
      ...
      while (pathScale >= minPathScale) {
        ...
        if (manualMode || (autonomyMode && autoAdjustMode)) {   // if manual flight mode or waypoint flight mode
          ...
          relativeGoalPitch = 0;
          relativeGoalYaw = 0;
        } else if (!autonomyMode) {                             // smart joystick mode, cannot change yaw
          relativeGoalDis = 1000.0;
